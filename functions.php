...
function theme_scripts(){
    ...
    if ( !is_admin() ) {
		...
		wp_register_script('custom2', ASSETS_URL . '/assets/scripts/custom2.js', array('jquery'), false, true);		
...
function theme_stylesheets(){
	...
	if( $styles_path ) {
		...
		wp_register_style('fonts-for-web', ASSETS_URL . '/assets/fonts-for-web/stylesheet.css', array(), false, 'all');
		wp_register_style('style', ASSETS_URL . '/assets/css/style.css', array(), false, 'all');
		wp_register_style('style2', ASSETS_URL . '/assets/css/style2.css',array('style'), false, 'all');
		// wp_register_style('main-css', ASSETS_URL . '/assets/css/main.css', array(), false, 'all');

		wp_enqueue_style('fonts-for-web');
...
add_image_size('logo-image', 38, 38, false);
add_image_size('works', 400, 300, true);
add_image_size('icon', 64, 64, false);
add_image_size('icon-social', 9999, 38, false);
